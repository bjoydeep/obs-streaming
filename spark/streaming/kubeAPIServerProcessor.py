...
#etcd_mvcc_db_total_size_in_bytes{job="etcd"} (changed in newer version ?)
#etcd_object_counts   (changed in newer version)
#apiserver_registered_watchers{apiserver="kube-apiserver"}
